...
/*bool BallTracker::IsBallPastIntake()
{
	
}

bool BallTracker::IsBallInBotLift()
{
...
bool BallTracker::IsBallInShooter()
{
	
}

if (ballCount == 0 || ballCount == 1 || ballCount == 2 && IsBallInShooter() == false)
{
